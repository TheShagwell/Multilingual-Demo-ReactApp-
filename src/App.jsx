...
const  App = () => {
  ...
  const releaseDate = new Date('2022-11-23')
    ...
    <>
      <div className="container">
        <div className="d-flex justify-content-end">
          ...
          <button className="btn btn-link dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false">
          <GlobeIcon />
          </button>
        ...
        <div className="d-flex flex-column align-items-start">
          ...
          {/* <h1 className="font-weight-bold">{t('other_messages')}</h1> */}
        </div>
      </div>
    </>
  ) 
